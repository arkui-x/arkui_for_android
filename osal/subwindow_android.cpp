...
void SubwindowAndroid::UpdateHideMenuOffsetNG(const NG::OffsetF& offset)
{
    ContainerScope scope(childContainerId_);
...
void SubwindowAndroid::ShowToast(const std::string& message, int32_t duration, const std::string& bottom,
