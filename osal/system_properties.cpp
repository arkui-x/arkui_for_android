...
std::string SystemProperties::brand_ = INVALID_PRARM;
std::string SystemProperties::manufacturer_ = INVALID_PRARM;
std::string SystemProperties::model_ = INVALID_PRARM;
std::string SystemProperties::product_ = INVALID_PRARM;
std::string SystemProperties::apiVersion_ = INVALID_PRARM;
std::string SystemProperties::releaseType_ = INVALID_PRARM;
std::string SystemProperties::paramDeviceType_ = INVALID_PRARM;
