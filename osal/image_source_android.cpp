...
int32_t ImageSourceAndroid::GetLoopCount()
{
    uint32_t errorCode;
...
std::vector<int32_t> ImageSourceAndroid::GetDelayTime()
{
    uint32_t errorCode;
...
ImageRotateOrientation ImageSourceAndroid::GetImageOrientation()
{
