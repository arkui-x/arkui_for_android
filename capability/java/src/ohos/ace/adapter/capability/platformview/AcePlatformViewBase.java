 ...
 */
 ...
 public abstract class AcePlatformViewBase {
     ...
     public AcePlatformViewBase(long id, IAceOnResourceEvent callback) {
         ...
         callMethodMap.put(PLATFORM_VIEW_FLAG + id + METHOD + PARAM_EQUALS + "registerPlatformView" + PARAM_BEGIN, callcreate);
         ...
         callMethodMap.put(PLATFORM_VIEW_FLAG + id + METHOD + PARAM_EQUALS + "updateLayout" + PARAM_BEGIN, callUpdateLayout);
