...
public abstract class VibratorPluginBase {
    ...
    /**
     * Run the vibrator with the specified effect ID and intensity.
     *
     * @param effectId Effect ID which set to vibrator.
     * @param intensity Intensity of vibration (0-100).
     */
    public abstract void vibrate(String effectId, float intensity);
