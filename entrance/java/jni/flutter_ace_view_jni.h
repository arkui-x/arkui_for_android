...
#ifndef FOUNDATION_ACE_ADAPTER_ANDROID_ENTRANCE_JAVA_JNI_ACE_VIEW_JNI_H
#define FOUNDATION_ACE_ADAPTER_ANDROID_ENTRANCE_JAVA_JNI_ACE_VIEW_JNI_H
...
public:
    ...
    static jlong CreateAndroidViewHandle(JNIEnv* env, jclass myClass, jobject view, jinit instanceId);
    ...
    static void DestorySurfaceHandle(JNIEnv* env, jobject myObject, jlong view);
    ...
    static void MakeTextureFrameAvailable(JNIEnv* env, jobject myObject, jlong view, jlong texture_id);
...
private:
    static jlong CreateViewHandle(JNIEnv* env, jclass myClass, jobject view, jinit instanceId, int32_t platform);
