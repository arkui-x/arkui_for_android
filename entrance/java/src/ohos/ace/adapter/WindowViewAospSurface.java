...
/**
 * WindowViewAospSurface is a class that implement WindowViewAospInterface interface.
 *
 * @since 2025-05-06
 */
public class WindowViewAospSurface extends WindowViewSurface implements WindowViewAospInterface {
    private WindowViewAospCommon windowViewAospCommon;

    /**
     * Constructor of WindowViewAospSurface
     *
     * @param context Application context
     * @param windowId Application window ID
     */
    public WindowViewAospSurface(Context context, int windowId) {
        super(context);
