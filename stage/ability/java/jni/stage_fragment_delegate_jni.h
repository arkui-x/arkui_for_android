...
#ifndef FOUNDATION_ACE_ADAPTER_ANDROID_STAGE_ABILITY_JAVA_JNI_STAGE_FRAGMENT_DELEGATE_JNI_H
#define FOUNDATION_ACE_ADAPTER_ANDROID_STAGE_ABILITY_JAVA_JNI_STAGE_FRAGMENT_DELEGATE_JNI_H
...
namespace Platform {
class StageFragmentDelegateJni {
public:
    StageFragmentDelegateJni() = delete;
    ~StageFragmentDelegateJni() = delete;
    ...
    static void AttachFragment(JNIEnv* env, jclass myclass, jstring jinstanceName, jobject object);
};
} // namespace Platform
} // namespace AbilityRuntime
} // namespace OHOS
#endif // FOUNDATION_ACE_ADAPTER_ANDROID_STAGE_ABILITY_JAVA_JNI_STAGE_FRAGMENT_DELEGATE_JNI_H